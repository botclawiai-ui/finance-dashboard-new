...
export default function NeuroDashboardPage() {
    ...
    useEffect(() => {
        // Neuro: account mapping
        fetchDashboardData(["Main (EUR) (8930)"], timeframe)
            .then(setData)
            .catch(console.error);
    }, [timeframe]);
    ...
    return (
        <>
            <header className="top-bar">
                <div>
                    <h1 className="page-title">Neuro Finanzen 🧠</h1>
                    <p className="page-subtitle">Übersicht für Neuro (Main 8930).</p>
                </div>
